...
# Technical notes
- I stored the BRFSS subset in the Hugo directory, `static/data/`. per the article, [Adding and reading local data files in R Markdown posts](https://blogdown-demo.rbind.io/2018/02/27/r-file-paths/). It might be worth exploring placing such files online in case I want to make code reproducible.
